...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV2_3_3(W(1,3),W(1,4),GC_83,GC_79,MDL_MZ, FK_MDL_WZ,W(1,5))
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,4))
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,3))
      CALL SSS1_1(W(1,4),W(1,3),GC_92,MDL_MH, FK_MDL_WH,W(1,6))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_82,GC_78,MDL_MZ, FK_MDL_WZ,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,5),W(1,3),W(1,6),GC_104,AMP(1))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_82,GC_78,MDL_MC, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS3_0(W(1,3),W(1,2),W(1,6),GC_109,AMP(2))
      CALL FFS3_2(W(1,1),W(1,6),GC_109,MDL_MC, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,5),GC_82,GC_78,AMP(3))
