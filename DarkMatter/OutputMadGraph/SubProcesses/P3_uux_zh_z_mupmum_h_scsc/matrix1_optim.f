...
C     
C     Process: u u~ > z h WEIGHTED<=4 @3
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 14
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 14
      ...
      CALL FFV2_3_3(W(1,5),W(1,7),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,9))  !  count 6
      ...
      CALL FFV2_3_3(W(1,6),W(1,8),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 6
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,13))  !  count 1
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,14))  !  count 1
      CALL SSS1_1(W(1,13),W(1,14),GC_92,MDL_MH,FK_MDL_WH,W(1,15))  !  count 26
      CALL FFV2_3_3(W(1,1),W(1,3),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      ...
      CALL FFV2_3_3(W(1,2),W(1,4),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,20))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,10),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,21))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,11),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,12),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,23))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,9),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,24))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,10),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,25))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,11),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,27))  !  count 1
      CALL FFS3P1N_1(W(1,4), W(1,15), GC_136, TMP(1))
      call CombineAmp(6,
     & (/2,1,4,3,7,8/), 
     & (/20,21,22,23,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,3), W(1,15), GC_136, TMP(1))
      call CombineAmp(6,
     & (/5,6,10,9,12,11/), 
     & (/21,22,24,25,26,27/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,15),GC_136,MDL_MU,FK_ZERO,W(1,28))  !  count 6
      CALL FFS3_2(W(1,2),W(1,15),GC_136,MDL_MU,FK_ZERO,W(1,29))  !  count 6
