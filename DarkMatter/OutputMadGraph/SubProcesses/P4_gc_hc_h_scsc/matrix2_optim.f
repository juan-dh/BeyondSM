...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL IXXXXX(P(0,5),MDL_MC,+1,-1*IC(5),W(1,8))  !  count 4
      CALL IXXXXX(P(0,5),MDL_MC,-1,-1*IC(5),W(1,9))  !  count 4
      CALL FFV1_2(W(1,8),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,8),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1_2(W(1,9),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_2(W(1,9),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,13))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_1(W(1,4),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3P1N_1(W(1,14), W(1,7), GC_109, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/8,9/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,17), W(1,7), GC_109, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/8,9/),
