...
C     
C     Process: g c > h c WEIGHTED<=3 @3
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL IXXXXX(P(0,2),MDL_MC,+1,+1*IC(2),W(1,3))  !  count 5
      CALL IXXXXX(P(0,2),MDL_MC,-1,+1*IC(2),W(1,4))  !  count 5
      ...
      CALL OXXXXX(P(0,5),MDL_MC,+1,+1*IC(5),W(1,8))  !  count 4
      CALL OXXXXX(P(0,5),MDL_MC,-1,+1*IC(5),W(1,9))  !  count 4
      CALL FFV1_2(W(1,3),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,4),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,13))  !  count 2
      CALL FFS3P1N_1(W(1,8), W(1,7), GC_109, TMP(1))
      call CombineAmp(2,
     & (/6,4/), 
     & (/10,13/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_1(W(1,9), W(1,7), GC_109, TMP(1))
      call CombineAmp(2,
     & (/5,3/), 
     & (/10,13/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_1(W(1,8),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,15))  !  count 2
      CALL FFV1_1(W(1,9),W(1,1),GC_11,MDL_MC,FK_ZERO,W(1,16))  !  count 2
      CALL FFV1_1(W(1,9),W(1,2),GC_11,MDL_MC,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3P1N_2(W(1,3), W(1,7), GC_109, TMP(1))
      call CombineAmp(4,
     & (/6,2,5,1/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_2(W(1,4), W(1,7), GC_109, TMP(1))
      call CombineAmp(4,
     & (/8,4,7,3/), 
     & (/14,15,16,17/),
