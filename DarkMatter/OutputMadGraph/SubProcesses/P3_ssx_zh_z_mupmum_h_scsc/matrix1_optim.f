...
C     
C     Process: s s~ > z h WEIGHTED<=4 @3
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 16
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 16
      ...
      CALL FFV2_3_3(W(1,6),W(1,8),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 8
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,13))  !  count 1
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,14))  !  count 1
      CALL SSS1_1(W(1,13),W(1,14),GC_92,MDL_MH,FK_MDL_WH,W(1,15))  !  count 30
      CALL FFV2_3_3(W(1,1),W(1,3),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 3
      CALL FFV2_3_3(W(1,1),W(1,4),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,3),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,4),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 3
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,10),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,21))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,11),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,12),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,23))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,9),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,24))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,10),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,25))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,11),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_81,GC_77,MDL_MS,FK_ZERO,W(1,27))  !  count 2
      CALL FFS3P1N_1(W(1,3), W(1,15), GC_125, TMP(1))
      call CombineAmp(7,
     & (/6,5,7,12,11,14,13/), 
     & (/20,21,22,24,25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,4), W(1,15), GC_125, TMP(1))
      call CombineAmp(7,
     & (/2,1,4,3,8,10,9/), 
     & (/20,21,22,23,25,26,27/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,15),GC_125,MDL_MS,FK_ZERO,W(1,28))  !  count 7
      CALL FFS3_2(W(1,2),W(1,15),GC_125,MDL_MS,FK_ZERO,W(1,29))  !  count 7
      CALL FFV2_3P1N_3(W(1,28), W(1,3), GC_81, GC_77, TMP(1))
      call CombineAmp(3,
     & (/6,5,7/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,28), W(1,4), GC_81, GC_77, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,29), W(1,3), GC_81, GC_77, TMP(1))
      call CombineAmp(4,
     & (/12,11,14,13/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,29), W(1,4), GC_81, GC_77, TMP(1))
      call CombineAmp(3,
     & (/8,10,9/), 
     & (/10,11,12/),
