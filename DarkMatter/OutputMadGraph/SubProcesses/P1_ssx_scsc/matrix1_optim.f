...
C     
C     Process: s s~ > h > sc sc WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFS3_3(W(1,1),W(1,3),GC_125,MDL_MH,FK_MDL_WH,W(1,7))  !  count 1
      CALL FFS3_3(W(1,2),W(1,4),GC_125,MDL_MH,FK_MDL_WH,W(1,8))  !  count 1
