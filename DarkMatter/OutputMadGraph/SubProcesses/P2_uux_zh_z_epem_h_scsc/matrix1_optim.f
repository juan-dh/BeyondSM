...
C     
C     Process: u u~ > z h WEIGHTED<=4 @2
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 5
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 10
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 10
      ...
      CALL FFV2_3_3(W(1,1),W(1,3),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,14))  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,4),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 2
      CALL FFV2_3_3(W(1,2),W(1,3),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      CALL FFV2_3_3(W(1,2),W(1,4),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,10),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,9),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,10),GC_82,GC_78,MDL_MU,FK_ZERO,W(1,21))  !  count 2
      CALL FFS3P1N_1(W(1,3), W(1,13), GC_136, TMP(1))
      call CombineAmp(4,
     & (/3,4,7,8/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,4), W(1,13), GC_136, TMP(1))
      call CombineAmp(4,
     & (/1,2,5,6/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,13),GC_136,MDL_MU,FK_ZERO,W(1,22))  !  count 4
      CALL FFS3_2(W(1,2),W(1,13),GC_136,MDL_MU,FK_ZERO,W(1,23))  !  count 4
      CALL FFV2_3P1N_1(W(1,3), W(1,9), GC_82, GC_78, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,3), W(1,10), GC_82, GC_78, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,4), W(1,9), GC_82, GC_78, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,4), W(1,10), GC_82, GC_78, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/22,23/),
