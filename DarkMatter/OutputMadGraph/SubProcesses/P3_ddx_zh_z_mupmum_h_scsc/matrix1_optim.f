...
C     
C     Process: d d~ > z h WEIGHTED<=4 @3
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 14
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 14
      ...
      CALL FFV2_3_3(W(1,1),W(1,3),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      ...
      CALL FFV2_3_3(W(1,2),W(1,4),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,20))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,10),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,21))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,11),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,12),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,23))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,9),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,24))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,10),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,25))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,11),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,27))  !  count 1
      CALL FFS3P1N_1(W(1,4), W(1,15), GC_112, TMP(1))
      call CombineAmp(6,
     & (/2,1,4,3,7,8/), 
     & (/20,21,22,23,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,3), W(1,15), GC_112, TMP(1))
      call CombineAmp(6,
     & (/5,6,10,9,12,11/), 
     & (/21,22,24,25,26,27/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,15),GC_112,MDL_MD,FK_ZERO,W(1,28))  !  count 6
      CALL FFS3_2(W(1,2),W(1,15),GC_112,MDL_MD,FK_ZERO,W(1,29))  !  count 6
