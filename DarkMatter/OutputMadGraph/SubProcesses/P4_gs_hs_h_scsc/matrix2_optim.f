...
C     
C     Process: g s~ > h s~ WEIGHTED<=3 @4
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 5
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 1
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 1
      CALL SSS1_1(W(1,5),W(1,6),GC_92,MDL_MH,FK_MDL_WH,W(1,7))  !  count 12
      CALL IXXXXX(P(0,5),MDL_MS,+1,-1*IC(5),W(1,8))  !  count 4
      CALL IXXXXX(P(0,5),MDL_MS,-1,-1*IC(5),W(1,9))  !  count 4
      CALL FFV1_2(W(1,8),W(1,1),GC_11,MDL_MS,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,8),W(1,2),GC_11,MDL_MS,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1_2(W(1,9),W(1,1),GC_11,MDL_MS,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_2(W(1,9),W(1,2),GC_11,MDL_MS,FK_ZERO,W(1,13))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11,MDL_MS,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_1(W(1,4),W(1,2),GC_11,MDL_MS,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3P1N_1(W(1,14), W(1,7), GC_125, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/8,9/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,17), W(1,7), GC_125, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/8,9/),
