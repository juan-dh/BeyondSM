...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL IXXXXX(P(0,2),MDL_MU,NHEL(2),+1*IC(2),W(1,2))
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,3))
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,4))
      CALL SSS1_1(W(1,3),W(1,4),GC_92,MDL_MH, FK_MDL_WH,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MU,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV1_2(W(1,2),W(1,1),GC_11,MDL_MU, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,3),W(1,4),W(1,5),GC_136,AMP(1))
      CALL FFV1_1(W(1,4),W(1,1),GC_11,MDL_MU, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS3_0(W(1,2),W(1,3),W(1,5),GC_136,AMP(2))
