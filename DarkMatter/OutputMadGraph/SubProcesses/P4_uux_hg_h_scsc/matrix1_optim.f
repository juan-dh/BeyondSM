...
C     
C     Process: u u~ > h g WEIGHTED<=3 @4
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 6
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 6
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 1
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 1
      CALL SSS1_1(W(1,5),W(1,6),GC_92,MDL_MH,FK_MDL_WH,W(1,7))  !  count 16
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,8))  !  count 4
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,9))  !  count 4
      CALL FFV1_2(W(1,1),W(1,8),GC_11,MDL_MU,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,1),W(1,9),GC_11,MDL_MU,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1_2(W(1,2),W(1,8),GC_11,MDL_MU,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_2(W(1,2),W(1,9),GC_11,MDL_MU,FK_ZERO,W(1,13))  !  count 2
      CALL FFS3P1N_1(W(1,3), W(1,7), GC_136, TMP(1))
      call CombineAmp(4,
     & (/4,3,8,7/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_1(W(1,4), W(1,7), GC_136, TMP(1))
      call CombineAmp(4,
     & (/2,1,6,5/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,3),W(1,8),GC_11,MDL_MU,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_1(W(1,3),W(1,9),GC_11,MDL_MU,FK_ZERO,W(1,15))  !  count 2
      CALL FFV1_1(W(1,4),W(1,8),GC_11,MDL_MU,FK_ZERO,W(1,16))  !  count 2
      CALL FFV1_1(W(1,4),W(1,9),GC_11,MDL_MU,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3P1N_2(W(1,1), W(1,7), GC_136, TMP(1))
      call CombineAmp(4,
     & (/4,3,2,1/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_2(W(1,2), W(1,7), GC_136, TMP(1))
      call CombineAmp(4,
     & (/8,7,6,5/), 
     & (/14,15,16,17/),
