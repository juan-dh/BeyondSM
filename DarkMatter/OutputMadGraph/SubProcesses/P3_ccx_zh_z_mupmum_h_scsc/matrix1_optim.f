...
C     
C     Process: c c~ > z h WEIGHTED<=4 @3
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     *   Decay: h > sc sc WEIGHTED<=2
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,4),I=1,6) / 1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,5),I=1,6) / 1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,6),I=1,6) / 1, 1, 1, 1, 0, 0/
      ...
      DATA (NHEL(I,11),I=1,6) /-1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,12),I=1,6) /-1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,13),I=1,6) /-1, 1, 1, 1, 0, 0/
      DATA (NHEL(I,14),I=1,6) /-1, 1,-1,-1, 0, 0/
      DATA (NHEL(I,15),I=1,6) /-1, 1,-1, 1, 0, 0/
      DATA IDEN/72/
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
        IF(ZERO.ne.0d0) fk_ZERO = SIGN(MAX(ABS(ZERO), ABS(mdl_msc__2
     $   *small_width_treatment)), ZERO)
      endif
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 7
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 18
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 16
      CALL IXXXXX(P(0,3),MDL_MMU,+1,-1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,3),MDL_MMU,-1,-1*IC(3),W(1,6))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MMU,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MMU,-1,+1*IC(4),W(1,8))  !  count 2
      CALL FFV2_3_3(W(1,5),W(1,7),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,9))  !  count 8
      CALL FFV2_3_3(W(1,5),W(1,8),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,10))  !  count 10
      CALL FFV2_3_3(W(1,6),W(1,7),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,11))  !  count 10
      CALL FFV2_3_3(W(1,6),W(1,8),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 10
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,13))  !  count 1
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,14))  !  count 1
      CALL SSS1_1(W(1,13),W(1,14),GC_92,MDL_MH,FK_MDL_WH,W(1,15))  !  count 32
      CALL FFV2_3_3(W(1,1),W(1,3),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 4
      CALL FFV2_3_3(W(1,1),W(1,4),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,3),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,4),GC_82,GC_78,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 3
      CALL VVS1P1N_1(W(1,16), W(1,15), GC_104, TMP(1))
      call CombineAmp(4,
     & (/6,5,8,7/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_1(W(1,17), W(1,15), GC_104, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_1(W(1,18), W(1,15), GC_104, TMP(1))
      call CombineAmp(4,
     & (/13,12,15,14/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_1(W(1,19), W(1,15), GC_104, TMP(1))
      call CombineAmp(3,
     & (/9,11,10/), 
     & (/10,11,12/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,10),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,21))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,11),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,12),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,23))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,9),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,24))  !  count 1
      CALL FFV2_3_2(W(1,2),W(1,10),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,25))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,11),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_82,GC_78,MDL_MC,FK_ZERO,W(1,27))  !  count 2
      CALL FFS3P1N_1(W(1,3), W(1,15), GC_109, TMP(1))
      call CombineAmp(8,
     & (/6,5,8,7,13,12,15,14/), 
     & (/20,21,22,23,24,25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,4), W(1,15), GC_109, TMP(1))
      call CombineAmp(7,
     & (/2,1,4,3,9,11,10/), 
     & (/20,21,22,23,25,26,27/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,15),GC_109,MDL_MC,FK_ZERO,W(1,28))  !  count 8
      CALL FFS3_2(W(1,2),W(1,15),GC_109,MDL_MC,FK_ZERO,W(1,29))  !  count 7
      CALL FFV2_3P1N_3(W(1,28), W(1,3), GC_82, GC_78, TMP(1))
      call CombineAmp(4,
     & (/6,5,8,7/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,28), W(1,4), GC_82, GC_78, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,29), W(1,3), GC_82, GC_78, TMP(1))
      call CombineAmp(4,
     & (/13,12,15,14/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_3(W(1,29), W(1,4), GC_82, GC_78, TMP(1))
      call CombineAmp(3,
     & (/9,11,10/), 
     & (/10,11,12/),
