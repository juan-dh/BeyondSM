...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL OXXXXX(P(0,5),MDL_MD,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV1_2(W(1,2),W(1,1),GC_11,MDL_MD, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,3),W(1,4),W(1,5),GC_112,AMP(1))
      CALL FFV1_1(W(1,4),W(1,1),GC_11,MDL_MD, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS3_0(W(1,2),W(1,3),W(1,5),GC_112,AMP(2))
