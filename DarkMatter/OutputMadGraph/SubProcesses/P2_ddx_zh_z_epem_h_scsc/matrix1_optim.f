...
C     
C     Process: d d~ > z h WEIGHTED<=4 @2
...
C     
      ...
      PARAMETER (NWAVEFUNCS=23, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MD,+1,+1*IC(1),W(1,1))  !  count 5
      CALL IXXXXX(P(0,1),MDL_MD,-1,+1*IC(1),W(1,2))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 10
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 10
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 1
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 1
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,7))  !  count 1
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,8))  !  count 1
      CALL FFV2_3_3(W(1,5),W(1,8),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,9))  !  count 10
      CALL FFV2_3_3(W(1,6),W(1,7),GC_83,GC_79,MDL_MZ,FK_MDL_WZ,W(1,10))  !  count 10
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,11))  !  count 1
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,12))  !  count 1
      CALL SSS1_1(W(1,11),W(1,12),GC_92,MDL_MH,FK_MDL_WH,W(1,13))  !  count 18
      CALL FFV2_3_3(W(1,1),W(1,3),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,14))  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,4),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 2
      CALL FFV2_3_3(W(1,2),W(1,3),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      CALL FFV2_3_3(W(1,2),W(1,4),GC_81,GC_77,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 2
      CALL VVS1P1N_2(W(1,9), W(1,13), GC_104, TMP(1))
      call CombineAmp(4,
     & (/3,1,7,5/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_2(W(1,10), W(1,13), GC_104, TMP(1))
      call CombineAmp(4,
     & (/4,2,8,6/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,9),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,10),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,9),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,10),GC_81,GC_77,MDL_MD,FK_ZERO,W(1,21))  !  count 2
      CALL FFS3P1N_1(W(1,3), W(1,13), GC_112, TMP(1))
      call CombineAmp(4,
     & (/3,4,7,8/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))
      CALL FFS3P1N_1(W(1,4), W(1,13), GC_112, TMP(1))
      call CombineAmp(4,
     & (/1,2,5,6/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,1),W(1,13),GC_112,MDL_MD,FK_ZERO,W(1,22))  !  count 4
      CALL FFS3_2(W(1,2),W(1,13),GC_112,MDL_MD,FK_ZERO,W(1,23))  !  count 4
      CALL FFV2_3P1N_1(W(1,3), W(1,9), GC_81, GC_77, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,3), W(1,10), GC_81, GC_77, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,4), W(1,9), GC_81, GC_77, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/22,23/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,4), W(1,10), GC_81, GC_77, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/22,23/),
