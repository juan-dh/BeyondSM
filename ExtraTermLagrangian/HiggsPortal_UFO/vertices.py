...
V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.P__tilde__sc, P.P__tilde__sc ],
             color = [ '1' ],
             lorentz = [ L.SSSS4 ],
             couplings = {(0,0):C.GC_52})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.P__tilde__sc, P.P__tilde__sc ],
             color = [ '1' ],
             lorentz = [ L.SSSS4 ],
             couplings = {(0,0):C.GC_52})

V_9 = Vertex(name = 'V_9',
             particles = [ P.H, P.H, P.P__tilde__sc, P.P__tilde__sc ],
             color = [ '1' ],
             lorentz = [ L.SSSS4 ],
             couplings = {(0,0):C.GC_52})

V_10 = Vertex(name = 'V_10',
              particles = [ P.P__tilde__sc, P.P__tilde__sc, P.P__tilde__sc, P.P__tilde__sc ],
              color = [ '1' ],
              lorentz = [ L.SSSS4 ],
...
V_14 = Vertex(name = 'V_14',
              particles = [ P.H, P.P__tilde__sc, P.P__tilde__sc ],
              color = [ '1' ],
              lorentz = [ L.SSS4 ],
