...
C     
C     Process: phi phi > phi phi WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      IF (FIRST) THEN
        FIRST=.FALSE.
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MPHI
...
C     Amplitude(s) for diagram number 1
      CALL SSSS1_0(W(1,1),W(1,2),W(1,3),W(1,4),GC_1,AMP(1))
